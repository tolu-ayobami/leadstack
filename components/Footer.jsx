    ...
    return (
        <div>
            <div className="bg-[#1A1D59] relative overflow-hidden">
                ...
                <div className="relative z-10 flex py-12 flex-col lg:flex-row container px-4 mx-auto items-center gap-10">
                    ...
                    <MotionItem variants={fadeInLeftVariants} once={false}>
                        <div className="flex justify-between py-6 flex-row max-md:flex-col-reverse gap-4">
                            <p className="font-noto text-sm font-medium text-[#656567] text-center max-md:text-center">
                                <Link href="https://leadstack.co/terms-of-use"> <span className=" hover:underline">Terms of Service</span></Link> &nbsp;|&nbsp; <Link href="https://leadstack.co/privacy-policy"><span className=" hover:underline">Privacy Policy of Leadstack</span></Link>
                            </p>
